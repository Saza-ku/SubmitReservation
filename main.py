...
from user import User, session, Assignment
from scrape import log_in_check, crawl_panda
...
def view_home():
    ...
    # 課題を取得
    assignments = session.query(Assignment).filter(Assignment.user_id == user_id).all()
